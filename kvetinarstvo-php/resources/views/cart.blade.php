  ...
  <section aria-label="Nákupný košík">
      @if(empty($cart))
          <div class="text-center py-5 text-muted">
              ...
              <a href="{{ url('/') }}" class="btn btn-outline-secondary mt-2">Späť na produkty</a>
          </div>
      @else
                      ...
                      <div class="d-flex flex-wrap align-items-center gap-3">
                          ...
                          <div class="d-flex align-items-center gap-3 ms-auto">
                              ...
                              <form method="POST" action="{{ route('cart.remove') }}">
                                  @csrf
                                  <input type="hidden" name="product_id" value="{{ $id }}">
                                  <button type="submit" class="remove-btn text-muted fs-5 ms-2 border-0 bg-transparent" title="Odstrániť z košíka" aria-label="Odstrániť produkt">
