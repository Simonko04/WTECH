    ...
    <section class="row g-4 align-items-stretch" aria-label="Profil používateľa">
        ...
        <div class="col-lg-5">
            <div class="bg-light p-5 rounded shadow-sm d-flex flex-column align-items-center text-center h-100">
                ...
                <!-- Meno -->
                <h1 id="user-display-name" class="fw-normal fs-4 mb-3">jozef mrkva</h1>

                <!-- Status -->
                <p>
                    <span id="user-status-label"
                          class="bg-secondary bg-opacity-25 px-4 py-1 rounded-pill small d-inline-block shadow-sm">
                        student
                    </span>
                </p>
                ...
                <div class="d-flex justify-content-center gap-3 mt-auto pt-3">
                    <button id="btn-history"
                            type="button"
                            class="action-button bg-secondary bg-opacity-25 border-0 px-4 py-2 rounded shadow-sm text-dark">
                        order history
                    </button>
        ...
        <div class="col-lg-7">
            <div class="bg-light p-5 rounded shadow-sm h-100 d-flex flex-column">
                ...
                <table class="table table-borderless mb-5 bg-transparent" style="--bs-table-bg: transparent;">
                    ...
                    <tr>
                        ...
                        <td class="fw-medium text-dark text-sm-end" id="user-email">
                            <a class="text-dark text-decoration-none">jozef.mrkva@student.stuba.sk</a>
                        </td>
                    </tr>
                ...
                <!-- Tlačidlá úpravy a odhlásenia -->
                <div class="mt-auto d-flex flex-column flex-sm-row justify-content-center gap-3">
                    <button id="edit_profile"
                            type="button"
                            class="action-button bg-secondary bg-opacity-25 border-0 px-5 py-2 rounded shadow-sm text-dark fw-medium">
                        change info
                    </button>
                    <!-- Tlačidlo odhlásenia -->
                    <button id="logout_button"
                            type="button"
                            class="btn btn-outline-danger px-5 py-2 rounded shadow-sm fw-medium">
                        log out
                    </button>
                </div>
