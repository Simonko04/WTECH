...
<main class="container py-5 flex-grow-1">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="Home_page.html" class="text-decoration-none text-muted">Home</a>
            </li>
    ...
    <figure class="text-center mb-5">
        <img src="img/kvet.jpg"
             alt="Logo kvetinarstvo.sk"
        ...
        <div class="bg-light p-5 rounded shadow-sm">
            ...
            <address class="d-flex flex-column gap-3 fs-6 m-0">
                ...
                <div class="d-flex flex-sm-row flex-column justify-content-between">
                    ...
                    <a class="fw-medium text-dark text-decoration-none">
